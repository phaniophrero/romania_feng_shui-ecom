<!--Header-part-->
<div id="header">
    <h1><a href="{{ url('/admin/dashboard') }}"><img class="dashboard-logo" src="{{ asset('images/logo/logo.png') }}">
            <img class="dashboard-logo-text" src="{{ asset('images/logo/logo-text.png') }}" alt=""></a></h1>
</div>
<!--close-Header-part-->
