        ...
        <div class="container">
            <div class="row">
                ...
                <p class="pull-right">Designed by <span><a target="_blank"
                            href="http://www.deca23designs.com">DeCA23Designs</a></span></p>
            </div>
        </div>
    </div>
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp == "exists") {
                    ...
                    $("#btnSubmit").hide();
                    $("#statusSubscribe").html("<div style='margin-top: -10px;'>&nbsp;</div><font color='red'>Subscriber email already exists!</font>");
                }
            }, error:function(){
                alert("Error");
            }
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp == "exists") {
                    ...
                    $("#statusSubscribe").show();
                    $("#statusSubscribe").html("<div style='margin-top: -10px;'>&nbsp;</div><font color='green'>Thanks for Subscribing!</font>");
                }
            }, error:function(){
                alert("Error");
            }
