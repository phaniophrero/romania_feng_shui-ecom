            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a class="logo-wrapper" href="{{ url('/') }}"><img class="logo-img"
                                src="{{ asset('images/logo/logo-text.png') }}" alt="" /></a>
                    </div>
                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                @else
                                <a href="{{ url('/cart') }}"><i class="fa fa-shopping-cart"></i> Cart
                                    ({{ $cartCount }})</a>
                                @endif
                            </li>
                            @if (empty(Auth::check()))
                ...
                <div class="col-sm-3">
                    <div class="search_box pull-right">
                        <form action="{{ url('/search-products') }}" method="post">
                            ...
                            <button type="submit" style="border:0px; height:35px;margin-left: -4px;">Search</button>
                        </form>
                    </div>
                </div>
            </div>
