...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                Home</a> <a href="#">Products</a> <a href="#" class="current">Add Product Attributes</a> </div>
                    ...
                    <div class="widget-content nopadding">
                        <form enctype="multipart/form-data" class="form-horizontal" method="post"
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"
                                    style="cursor: default;"><strong>{{ $productDetails->product_color }}</strong></label>
                            </div>
                            <div class="control-group">
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            <?php /* <a rel="{{ $attribute->id }}" rel1="delete-attribute" href="javascript:"
