                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post"
                            action="{{ url('/admin/edit-shipping/'.$shippingDetails->id) }}" name="edit_shipping"
                            id="edit_shipping" novalidate="novalidate">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{ url($shippingDetails->id) }}">
                            ...
                            <div class="control-group">
                                <label class="control-label">Shipping Charges (2001-6000g)</label>
                                <div class="controls">
                                    <input type="text" name="shipping_charges2001_6000g" id="shipping_charges2001_6000g"
                                        value="{{ $shippingDetails->shipping_charges2001_6000g }}">
                                </div>
                            </div>
