...
<section id="do_action">
    <div class="container">
        <div class="heading">
            ...
            <p>Choose if you have a coupon code or you want to use.</p>
        </div>
        <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                <div class="total_area">
                    <ul>
                        ...
                        <li>Sub Total <span>RON <?php echo $total_amount; ?></span></li>
                        ...
                        <li>Total <span data-toggle="tooltip" data-html="true" title="USD {{ $getCurrencyRates['USD_Rate'] }} <br>
