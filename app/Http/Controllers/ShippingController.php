...
class ShippingController extends Controller
{
    ...
    public function editShipping($id, Request $request)
    {
        if($request->isMethod('post')) {
            ...
            ShippingCharge::where('id',$id)->update(['shipping_charges0_500g'=>$data['shipping_charges0_500g'], 'shipping_charges501_1000g'=>$data['shipping_charges501_1000g'], 'shipping_charges1001_2000g'=>$data['shipping_charges1001_2000g'], 'shipping_charges2001_6000g'=>$data['shipping_charges2001_6000g']]);
            return redirect()->back()->with('flash_message_success', 'Shipping Charges have been successfully updated!');
        }
