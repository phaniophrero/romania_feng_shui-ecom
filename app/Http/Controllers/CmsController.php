...
class CmsController extends Controller
{
    ...
    {
        // Redirect to 404 if CMS Page is disabled or does not exist
        ...
        return view('pages.cms_page', compact('cmsPageDetails', 'categories','categories_menu', 'meta_title', 'meta_description', 'meta_keywords'));
    }
    ...
    public function contact(Request $request)
    {
        if($request->isMethod('post')) {
            ...
            // Send Contact Email / Aici trebuie sa adaugam email-ul de contact al Brandului
            ...
            Mail::send('emails.enquiry', $messageData, function($message) use($email){
               $message->to($email)->subject('Enquiry from Romania Feng Shui Store');
            });
        ...
        $meta_title = "Contact Us - Romania Feng Shui";
        $meta_description = "Contact us for any queries related to our products.";
        $meta_keywords = "contact us, queries, romania feng shui, marian golea, anca dimancea";

        return view('pages.contact',compact('categories','categories_menu', 'meta_title', 'meta_description', 'meta_keywords'));
    }
    ...
    public function getEnquiries()
    {
        ...
        $enquiries = json_decode(json_encode($enquiries));
        return $enquiries;
    }
