...
class Product extends Model
{
    ...
    public static function getCurrencyRates($price) {
        ...
        $currenciesArr = array('USD_Rate'=> $USD_Rate,'EUR_Rate'=>$EUR_Rate,'GBP_Rate'=>$GBP_Rate);
    ...
    public static function getShippingCharges($total_weight, $country)
    {
        ...
        if($total_weight > 0) {
            ...
            } else if($total_weight > 2001 && $total_weight <= 6000) {
                $shipping_charges = $shippingDetails->shipping_charges2001_6000g;
            } else {
                $shipping_charges = 0;
            }
        }else {
