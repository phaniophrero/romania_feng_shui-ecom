$(document).ready(function () {
    ...
    $(document).ready(function () {
        var maxField = 10; //Inputn fields increment limitation
        ...
        var x = 1; //Initial field computer is 1
        $(addButton).click(function () { // Omce add button is clicked
